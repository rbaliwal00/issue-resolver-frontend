...
import { allRequestedCommunitiesByUser, retrieveAllCommunities } from '../../api/CommunityApiService';
...
const RequestedCommunities = () => {
    ...
    const refreshCommunities = () =>{
        allRequestedCommunitiesByUser(page, query, user?.id)
        .then(res => {
...
export default RequestedCommunities;