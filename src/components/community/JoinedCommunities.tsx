...
import { allJoinedCommunitiesByUser, retrieveAllCommunities, retrieveCommuityByUser } from '../../api/CommunityApiService';
...
const JoinedCommunities = () => {
    ...
    const dispatch = useAppDispatch();
        ...
        const refreshIssues = () =>{
            allJoinedCommunitiesByUser(page, query, user?.id)
            .then(res => {
                console.log(res.data);
                setCommunities(res.data.results.content);
                setNumberOfPages(res.data.results.totalPage)
                setIssueContent({
                    content: [],
                    totalPage: res.data.results.totalPages,
                    totalElements: res.data.results.totalElements,
                    pageSize: res.data.results.pageSize,
                    lastPage: res.data.results.lastPage,
                    pageNumber: res.data.results.pageNumber
                })
            })
    ...
    </div> : <div>You haven't joined any community yet.</div>}
